...
public class CollectAlgae extends Command {
  ...
  public void initialize() {
    ...
    // If they press while holding an algae
  ...
  public void execute() {
    ...
    if (m_detected == false) {
      m_algaeIntake.spinWheels(m_speed);
      m_algaeIntake.movePivotWithPID(
          m_algaeIntake.getPivotEncoderPos(), Constants.AlgaeIntakeConstants.EXTENDED_POSITION);

    } else if (m_detected == true) {
      m_algaeIntake.spinWheels(0);
      m_algaeIntake.movePivotWithPID(
          m_algaeIntake.getPivotEncoderPos(), Constants.AlgaeIntakeConstants.STOW_POSITION);
    }
  }
